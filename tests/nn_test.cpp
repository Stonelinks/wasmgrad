...
#include <memory>
#include <wasmgrad/engine.hpp>
#include <wasmgrad/nn.hpp>
#include <vector>

using std::make_shared;
using std::vector;
using std::initializer_list;
using wasmgrad::Layer;
using wasmgrad::MLP;
using wasmgrad::Module;
using wasmgrad::Neuron;
using wasmgrad::Value;
using wasmgrad::ValuePtr;
...
TEST(MLPTest, ReluActZero) {
  const size_t in_nr = 2;
  const initializer_list<size_t> outs_nr = {4llu, 4llu, 1llu};
